...
/**
 * 
 * Monster is a abstract class which defines the basic 
 * characteristics of all monster types,
 * including platform collisions and basic AI movement.
 *
 */
public abstract class Monster extends Collidable {
	...
	/**
	 * The Monster determines its movement based on the Hero's location and randomly 
	 * selected distances. If the Hero is positioned above the Monster, there is a chance 
	 * for the Monster to jump. The Monster randomly chooses a distance to move towards, 
	 * then randomly changes direction and repeats this behavior.
	 */
